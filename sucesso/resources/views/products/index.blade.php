...
<div class="row">
  @foreach ($products->fresh() as $p)
      <div class="col-sm-4">
        <div class="product_item">
          <a href="{{route('products.show', $p->id)}}">
          <div class="product_tags">
            {{-- <div class="product_tag product_tag_red"></div>
            <div class="product_tag product_tag_green"></div>
            <div class="product_tag product_tag_blue"></div> --}}
          </div>
