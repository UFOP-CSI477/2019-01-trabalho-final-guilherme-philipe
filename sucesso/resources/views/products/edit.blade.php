      ...
      {{-- {{dd($product)}} --}}
       ...
       <form class="form-group" action="{{ route('products.update', $product->id)}}" method="post">
        ...
        <div class="row jumbotron">
          <div class="col-sm-6">
            <p class="form-group">
            Nome: <input class="form-control m-4" typer="text" name="name" value="{{$product->name}}">
            </p>
            ...
            <small>* O preço anterior é atualizado com o valor corrente do combustível</small>
            </p>

						<p class="form-group">
            Descrição: <input class="form-control m-4" typer="text" name="description" value="{{$product->description}}">
            </p>
						<div display="none">
							<input hidden name="id_category" value="{{$product->id_category}}">
							<input hidden name="stock" value="{{$product->stock}}">
							<input hidden name="rating" value="{{$product->rating}}">
							<input hidden name="featured" value="{{$product->featured}}">
							<input hidden name="sale" value="{{$product->sale}}">
							<input hidden name="bestseller" value="{{$product->bestseller}}">
							<input hidden name="options" value="{{$product->options}}">
							<input hidden name="new_product" value="{{$product->new_product}}">
          ...
          <div class="col-sm-6">
            <p class="form-group">
              Preço: <input class="form-control" typer="text" name="price" value="{{$product->price}}">
            </p> <br>
            <p class="form-group">
              Posto ofertante:
